...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--Ntrials", dest="Ntrials", default=10,
                        type=int, help="number of randomization trials")
    ...
    parser.add_argument("-m", "--matlab", dest="matfile", action="store_true",
                        default=False,
    ...
    if (options.norm != 'frob') & (options.norm != 'spec'):
        sys.exit("The option -n must be set to 'frob' or 'spec' - other"
