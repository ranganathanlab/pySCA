...
number of gaps in the alignment. This script reads in the alignment, computes
...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--tolerance", dest="tol", type=int, default=50,
                        help="allowable sequence length variation in number of"
                             " amino acids (alignment will be trimmed to mean"
